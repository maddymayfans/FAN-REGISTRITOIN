...
<body>
    <div id="signup-page" class="container">
        <header>MADDY MAY SUPERFAN</header>
    ...
    <div id="thank-you-subscription-page" class="container hidden">
        ...
        <p>We have received your subscription request and payment screenshot. Thank you for subscribing to Maddy May Super Fans! We will review your submission and provide you with exclusive access shortly.</p>
    </div>
</body>
</html>
